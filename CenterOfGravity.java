/*
Problem Description:
Give an array of positive integers, return the center of gravity.
Center of gravity is the position of 2 adjacent elements, that the sum of the left side is closest to the sum of the right side.
