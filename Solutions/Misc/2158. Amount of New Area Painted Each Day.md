...
class Solution {
    public int[] amountPainted(int[][] mx) {
        ...
        for (int i = 0; i < mx.length; i++) {
            ...
            // [2,5](start,end) vs [5,8](entry, painted): merge
            // [2,5](start,end) vs [3,8](entry, painted): merge & remove [3,5] from toPaint
            // [2,5](start,end) vs [3,4](entry, painted): merge & remove [3,4] from toPaint
